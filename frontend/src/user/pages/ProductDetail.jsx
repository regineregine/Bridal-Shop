    ...
    <div className="flex min-h-screen flex-col bg-white">
          ...
          <div className="flex flex-col justify-center">
              ...
              <div className="mb-8">
                ...
                {isLoggedIn && savedMeasurements && (
                  <div className="mb-4 flex items-start gap-3 p-3 bg-pink-50 border border-pink-200 rounded-lg">
                    ...
                    />
                    <label htmlFor="use-custom-size" className="text-sm text-slate-700 cursor-pointer flex-1">
                      <span className="font-medium block mb-1">Use my saved custom measurements</span>
                      {savedMeasurements && (
                        <span className="text-xs text-slate-600 block">
                          Bust: {savedMeasurements.bust}", Waist: {savedMeasurements.waist}", Hips: {savedMeasurements.hips}"
                        </span>
                      )}
                    </label>
                  </div>
                ...
                {useCustomSize && (
                  <div className="bg-pink-50 border border-pink-200 rounded-lg p-4">
                    <p className="text-sm text-slate-700">
                      <strong>Custom Size Selected:</strong> Your saved measurements will be used for this order.
                    </p>
                  </div>
                )}
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-yellow-800">
                      <strong>Diet & Weight Changes:</strong> If your current diet or weight is expected to change significantly by the delivery date, 
                      the dress may not fit properly. Please consider maintaining a stable weight during the ordering period or ordering closer to your event date.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="flex gap-4">
              {isLoggedIn ? (
                ...
                >
                  {product.stock === 0 ? 'Out of Stock' : 'Log in to add to cart'}
                </button>
              )}
      ...
      <SizeCustomizationModal
        ...
        onSave={(measurements) => {
          ...
          toast.success('Measurements saved! They will be used for this order.');
        }}
