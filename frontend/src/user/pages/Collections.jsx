        ...
        <div className="relative z-10 m-auto max-w-7xl justify-center py-5">
            ...
            <div className="grid grid-cols-1 gap-8 px-4 sm:grid-cols-2 lg:grid-cols-3">
              {collections.length === 0 ? (
                ...
                collections.map((collection) => (
                  <div
                    key={collection.id}
                    className="group cursor-pointer overflow-hidden rounded-lg bg-white shadow-[0_8px_30px_rgba(210,199,229,0.12)] transition-all duration-300 hover:shadow-[0_12px_40px_rgba(210,199,229,0.2)]"
                  >
                    ...
                    <div className="p-6 text-center">
                      <h3 className="font-Tinos text-2xl text-slate-900">
                        {collection.name}
                      </h3>
          ...
          <div className="mt-10 text-center px-4">
            ...
            <p className="text-slate-700 mb-8 max-w-2xl mx-auto">
              Book an appointment with us today and let our experts help you
