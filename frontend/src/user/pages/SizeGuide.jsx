      ...
      <section className="py-16 md:py-10">
        <div className="relative z-10 m-auto max-w-7xl justify-center px-4 pb-4">
          ...
          >
            ...
            <div className="bg-pink-50 rounded-lg p-6 max-w-4xl mx-auto">
              <p className="text-slate-700">
                <strong>Note:</strong> If your measurements fall between two sizes, we recommend choosing the larger size.
                It is always easier to take a dress in than to let it out.
              </p>
            </div>
          </div>
