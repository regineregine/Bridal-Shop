...
export default function AuthModal({
  ...
  const handleChange = (e) => {
    ...
    if ((name === 'email' || name === 'password' || name === 'confirm_password') && value.includes(' ')) {
      return;
    }
  ...
  const handleRegister = async (e) => {
    ...
    // Validate all fields
    const fieldsToValidate = ['first_name', 'last_name', 'email', 'contact_number', 'password', 'confirm_password'];
    let isValid = true;
