        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-slate-700 text-base">
              Have questions or want to schedule a fitting? Reach out to us through any of the following ways.
            </p>
          </div>
            ...
            <div className="bg-pink-50 border border-pink-200 rounded-xl p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <a href="mailto:cloningmoon@gmail.com" className="text-pink-600 hover:text-pink-700 hover:underline">
            ...
            <div className="bg-pink-50 border border-pink-200 rounded-xl p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <a href="tel:+639123456789" className="text-pink-600 hover:text-pink-700 hover:underline">
                    +63 912 345 6789
                  </a>
                </div>
              </div>
          ...
          <div className="border-t border-gray-200 pt-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h4 className="font-semibold text-slate-900 mb-4 text-lg">Visit Us</h4>
              ...
              <div>
                <h4 className="font-semibold text-slate-900 mb-4 text-lg">Opening Hours</h4>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <h4 className="font-semibold text-slate-900 mb-4 text-lg text-center">Follow Us</h4>
