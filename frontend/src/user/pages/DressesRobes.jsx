...
export default function DressesRobes() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await api.get('/products?category=dresses');
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <Hero 
        title="DRESSES" 
        highlight="& ROBES" 
        subtitle="Explore our exquisite collection of wedding dresses and luxurious robes."
        extraClass="py-32"
      />
