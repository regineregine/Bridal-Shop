  ...
  return (
    <div className="bg-white">
      ...
      >
        ...
        <div className="relative z-10 flex h-full w-full flex-col items-start justify-center px-6 sm:px-8 text-left lg:pl-24">
          {/* Main Heading */}
          <h1 className="pl-0 sm:pl-10 md:pl-20 lg:pl-30 font-GreatVibes text-white mb-6 sm:mb-8 md:mb-10 text-5xl sm:text-6xl md:text-7xl lg:text-9xl">
            {isLoggedIn ? (
              <>Wedding Dresses</>
            ) : (
              <>
                Welcome to <span className=" text-pink-300">Pro</span>
                <span className=" text-pink-500">mise</span>{' '}
              </>
            )}
          </h1>

          {/* Subtext */}
          <p className="pl-0 sm:pl-20 md:pl-30 lg:pl-40 font-Unna stroke-black max-w-2xl sm:max-w-3xl lg:max-w-4xl text-base sm:text-lg md:text-xl lg:text-2xl text-white leading-relaxed">
            We design and curate stunning wedding dresses, blending elegance,
            comfort, and romance—because every bride deserves to shine on her
            wedding day.
          </p>

          {/* Buttons */}
          {isLoggedIn && (
            <div className="pl-0 sm:pl-20 md:pl-40 lg:pl-70 mt-6 sm:mt-8 lg:mt-12 flex flex-col gap-3 sm:flex-row sm:gap-6 lg:gap-10 w-full sm:w-auto">
              <a
                href="/profile"
                className="rounded-full border-2 border-white bg-transparent px-6 py-3 text-center text-base font-semibold text-white transition-all duration-300 hover:bg-white hover:text-slate-900 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-transparent sm:px-8 md:px-10 sm:py-4 sm:text-lg active:scale-95"
              >
                View Profile
              </a>
              <a
