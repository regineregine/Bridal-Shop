  ...
  return (
    <AdminLayout>
      <div className="max-w-4xl">
        <div className="mb-6">
          <h1 className="text-3xl font-semibold text-slate-900 mb-2">Edit Product</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-6">
          ...
          <div className="flex gap-4 pt-4">
            ...
            <button
              ...
              className="px-6 py-3 border border-gray-300 rounded-lg font-semibold text-slate-700 hover:bg-gray-50 transition-colors"
            >
              Cancel
            </button>
          </div>
